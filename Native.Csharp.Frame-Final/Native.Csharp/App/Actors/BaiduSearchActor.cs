    ...
    class BaiduSearchActor
    {
        ...
        public string[] getBaiduKGResult(string words)
        {
            ...
            try
            {
                ...
                if (tnode != null)
                {
                    string gdp = parser.removeUnText(tnode.InnerText);
                    reslist.Add(gdp);
                }
            ...
            try
            {
                ...
                if (tnode != null)
                {
                    string common = parser.removeUnText(tnode.InnerText);
                    reslist.Add(common);
                }
            ...
            try
            {
                ...
                if (tnode != null)
                {
                    string gp = parser.removeUnText(tnode.InnerText);
                    reslist.Add(gp);
            ...
            try
            {
                ...
                if (tnode != null)
                {
                    string rx = parser.removeUnText(tnode.InnerText);
                    reslist.Add(rx);
                }
            ...
            try
            {
                ...
                if (tnode != null)
                {
                    string trans = parser.removeUnText(tnode.InnerText);
            ...
            try
            {
                ...
                if (tnode != null)
                {
                    string hl = parser.removeUnText(tnode.InnerText);
                    reslist.Add(hl);
                }
            ...
            try
            {
                ...
                if (tnode != null)
                {
                    string dw = parser.removeUnText(tnode.InnerText);
                    reslist.Add(dw);
                }
            ...
            try
            {
                ...
                if (tnode != null)
                {
                    string dw = parser.removeUnText(tnode.GetAttributeValue("href", ""));
            ...
            try
            {
                ...
                if (tnode != null)
                {
                    string dw = parser.removeUnText(tnode.ChildNodes[3].FirstChild.GetAttributeValue("href", ""));
        ...
        public string[] getBaiduTiebaAnswers(string sentence, int num = 10)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    if(tiezinodes==null) return res.ToArray();
                    int numm = 0;
        ...
        public string[] getBaiduZhidaoAnswersByUrl(string url)
        {
            ...
            // 新版最佳答案
            try
            { var node = hdoc.DocumentNode.SelectSingleNode("//*[@class=\"best-text mb-10\"]");
                if (node != null)
                {
                    string dw = node.InnerHtml;
