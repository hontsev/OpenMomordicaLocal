...
namespace Native.Csharp.App
{
    ...
    public class MomordicaMain
    {
        ...
        public void dealPrivateMsg(long user, string question)
        {
            ...
            {
                // test
                // SendPrivateMessage(user, "[CQ: rich, url = https://i.y.qq.com/v8/playsong.html?songid=201243685&amp;source=yqq#wechat_redirect,text=来自QQ音乐的分享 《Lightbreaker》]");
            }
        ...
        {
            return true;
            //AddLoger(Sdk.Cqp.Enum.LogerLevel.Info, "name", name);
            try
            {
        ...
        public string getWelcomeString()
        {
            tryInit();
            return "" +
                $"您正在使用单机版{config.askName}。直接发内容，无需开头称谓。\r\n" +
                "以下是群常用功能。私聊可以闲聊。\r\n" +
                "~状态查看：“状态”\r\n" +
                "~模式更换：“模式列表”、“xx模式on”\r\n" +
                "~掷骰：“rd 成功率”“r3d10 攻击力”\r\n" +
